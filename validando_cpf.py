...
#     if len(digite_seu_cpf) != 11 or not digite_seu_cpf.isdigit():
#         print('Erro: O CPF deve ter exatamente 11 dígitos e apenas números.')
#     else:
#         break
...
#         int(digite_seu_cpf)  # tenta converter para número

#         if len(digite_seu_cpf) != 11:
